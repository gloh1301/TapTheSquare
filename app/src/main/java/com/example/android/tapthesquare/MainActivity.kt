package com.example.android.tapthesquare
...
const val EXTRA_SQUARE_SIZE = "com.example.android.tapthesquare.SQUARE_SIZE"
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleSquareResult(result: ActivityResult) {
        if (result.resultCode == RESULT_OK) {
            ...
            Toast.makeText(this, getString(R.string.hit_back), Toast.LENGTH_SHORT).show()
        }
    }
}